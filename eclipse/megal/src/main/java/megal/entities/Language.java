...
public class Language extends Set {
    ...
    /**
     * @return Base URL of 101companies discovery servicy, depending on the
     * entity type.
     */
    private String getBaseUrl() {
        ...
        if (typeName.equals("Language")) {
            return base + "languages/" + getEdecl().getName();
        };
        if (typeName.equals("Technology")) {
            return base + "technologies/" + getEdecl().getName();
        };
